...
public class MainActivity extends Activity {
    ...
    TextView userInputText = null;
    TextView mStackText = null;
    TextView memoryStatText = null;
    ...
    private void ProcessKeypadInput(KeypadButton keypadButton) {
        ...
        switch (keypadButton) {
            ...
            case SQRT:
                ...
                userInputText.setText(doubleToString(Math.sqrt(userInputValue)));
                break;
            case CALCULATE:
            ...
            case RECIPROC:
                ...
                if(Double.isNaN(userInputValue))
                    return;
                userInputText.setText(doubleToString(1/userInputValue));
                break;
            case PERCENT:
                userInputValue = tryParseUserInput();
                if(Double.isNaN(userInputValue))
                    return;
                userInputText.setText(doubleToString(userInputValue));
